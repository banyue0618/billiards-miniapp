    ...
    <el-form ref="registerRef" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item style="width: 100%; margin-top: -10px;">
        <div style="display: flex; justify-content: space-between; width: 100%;">
          <router-link class="link-type" :to="'/system/tenantApply'">申请成为租户</router-link>
<!--          <router-link class="link-type" :to="'/system/merchantApply'">申请成为商户</router-link>-->
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
    <div class="el-register-footer">
      <span>Copyright © 2025-2025 banyue All Rights Reserved.</span>
    </div>
  </div>
</template>
