        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="过期时间" prop="expireTime">
              <el-date-picker v-model="queryParams.expireTime" clearable type="date" value-format="YYYY-MM-DD" placeholder="请选择过期时间" />
            </el-form-item>
            <el-form-item>
    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-hasPermi="['billiards:memberPointsValidity:add']" type="primary" plain icon="Plus" @click="handleAdd">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
              v-hasPermi="['billiards:memberPointsValidity:edit']"
              type="success"
              plain
              icon="Edit"
              :disabled="single"
          ...
          <el-col :span="1.5">
            <el-button
              v-hasPermi="['billiards:memberPointsValidity:remove']"
              type="danger"
              plain
              icon="Delete"
              :disabled="multiple"
          ...
          <el-col :span="1.5">
            <el-button v-hasPermi="['billiards:memberPointsValidity:export']" type="warning" plain icon="Download" @click="handleExport"
              >导出</el-button
            >
          </el-col>
...
import {
  listMemberPointsValidity,
  getMemberPointsValidity,
  delMemberPointsValidity,
  addMemberPointsValidity,
  updateMemberPointsValidity
} from '@/api/billiards/memberPointsValidity';
...
const data = reactive<PageData<MemberPointsValidityForm, MemberPointsValidityQuery>>({
  ...
  rules: {
    ...
    points: [{ required: true, message: '积分数量不能为空', trigger: 'blur' }],
    remainingPoints: [{ required: true, message: '剩余积分数量不能为空', trigger: 'blur' }],
...
const handleExport = () => {
  proxy?.download(
    'billiards/memberPointsValidity/export',
    {
      ...queryParams.value
    },
