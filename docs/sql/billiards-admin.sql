CREATE DATABASE IF NOT EXISTS `billiards_admin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO billiards_admin.sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,query_param,is_frame,is_cache,menu_type,visible,status,perms,icon,create_dept,create_by,create_time,update_by,update_time,remark) VALUES
...
insert into sys_menu (menu_id, menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark)
values(40016, '租户审核', 4001, '1',  '#', '', 1, 0, 'F', '0', '0', 'system:tenantApply:audit',        '#', 103, 1, sysdate(), null, null, '');
