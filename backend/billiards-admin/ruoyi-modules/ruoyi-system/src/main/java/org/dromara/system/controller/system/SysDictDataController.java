...
public class SysDictDataController extends BaseController {
     ...
     * 根据字典类型查询字典数据信息
     *
     * @param dictType 字典类型 (多个使用逗号分隔)
     */
    @GetMapping(value = "/types/{dictType}")
    public R<Map<String,List<SysDictDataVo>>> dictTypes(@PathVariable String dictType) {
        Map<String,List<SysDictDataVo>> data = dictTypeService.selectDictDataByType(dictType.split(","));
        return R.ok(data);
    }
}
