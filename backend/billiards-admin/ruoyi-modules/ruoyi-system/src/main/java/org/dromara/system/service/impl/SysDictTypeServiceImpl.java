...
public class SysDictTypeServiceImpl implements ISysDictTypeService, DictService {
    ...
    @Override
    public Map<String, List<SysDictDataVo>> selectDictDataByType(String... dictType) {
        HashMap<String, List<SysDictDataVo>> hashMap = new HashMap<>();
        for (String type : dictType) {
            hashMap.put(type, SpringUtils.getAopProxy(this).selectDictDataByType(type));
        }
        return hashMap;
    }
