...
import org.dromara.common.pay.enums.*;
import org.dromara.common.pay.model.v2.*;
...
public class WxPayApi {
     ...
     */
    public static PayHttpResponse v3(RequestMethodEnum method, String urlPrefix, String urlSuffix,
     ...
     * @throws Exception 接口执行异常
     */
    public static PayHttpResponse v3(RequestMethodEnum method, String urlPrefix, String urlSuffix, String mchId,
     ...
     * @throws Exception 接口执行异常
     */
    public static PayHttpResponse v3(String urlPrefix, String urlSuffix, String mchId, String serialNo, String platSerialNo, String keyPath, String body, File file) throws Exception {
        long timestamp = System.currentTimeMillis() / 1000;
        String authType = AuthTypeEnum.RSA.getUrl();
        String nonceStr = WxPayKit.generateStr();
     ...
     * @throws Exception 接口执行异常
     */
    public static PayHttpResponse v3(String urlPrefix, String urlSuffix, String mchId, String serialNo,
    ...
    public static Map<String, Object> v3Execution(RequestMethodEnum method, String urlPrefix, String urlSuffix,
                                                  ...
                                                  String body, String nonceStr, long timestamp, String authType,
                                                  File file) throws Exception {
        PayHttpResponse response = v3(method, urlPrefix, urlSuffix, mchId, serialNo, platSerialNo, keyPath, body, nonceStr, timestamp, authType, file);
    ...
    public static Map<String, Object> v3Execution(RequestMethodEnum method, String urlPrefix, String urlSuffix, String mchId,
        ...
        PayHttpResponse response = v3(method, urlPrefix, urlSuffix, mchId, serialNo, null, keyPath, body);
        return buildResMap(response);
    }
    ...
    public static Map<String, Object> v3Execution(RequestMethodEnum method, String urlPrefix, String urlSuffix, String mchId,
                                                  String serialNo, String platSerialNo, String keyPath, String body) throws Exception {
        PayHttpResponse response = v3(method, urlPrefix, urlSuffix, mchId, serialNo, platSerialNo, keyPath, body);
        return buildResMap(response);
    }
    ...
    public static Map<String, Object> v3Execution(RequestMethodEnum method, String urlPrefix, String urlSuffix,
                                                  String mchId, String serialNo, String platSerialNo, String keyPath,
                                                  Map<String, String> params) throws Exception {
        PayHttpResponse response = v3(method, urlPrefix, urlSuffix, mchId, serialNo, platSerialNo, keyPath, params);
        return buildResMap(response);
    }
    ...
    public static Map<String, Object> v3Execution(RequestMethodEnum method, String urlPrefix, String urlSuffix,
                                                  ...
                                                  Map<String, String> params) throws Exception {
        PayHttpResponse response = v3(method, urlPrefix, urlSuffix, mchId, serialNo, null, keyPath, params);
        return buildResMap(response);
    }
    ...
    public static Map<String, Object> v3Upload(String urlPrefix, String urlSuffix, String mchId, String serialNo, String platSerialNo, String keyPath, String body, File file) throws Exception {
        PayHttpResponse response = v3(urlPrefix, urlSuffix, mchId, serialNo, platSerialNo, keyPath, body, file);
        return buildResMap(response);
    }
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse get(String url, Map<String, Object> params, Map<String, String> headers) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse get(String url, String authorization, String serialNumber, Map<String, Object> params) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse delete(String url, String data, Map<String, String> headers) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse delete(String url, String authorization, String serialNumber, String data) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse upload(String url, Map<String, Object> params, Map<String, String> headers) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse upload(String url, String authorization, String serialNumber, String data, File file) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse put(String url, String data, Map<String, String> headers) {
     ...
     * @return {@link PayHttpResponse}    请求返回的结果
     */
    public static PayHttpResponse put(String url, String authorization, String serialNumber, String data) {
     ...
     * 构建返回参数
     *
     * @param response {@link PayHttpResponse}
     * @return {@link Map}
     */
    public static Map<String, Object> buildResMap(PayHttpResponse response) {
        if (response == null) {
            return null;
        }
