...
## 正式支付配置
- 如果介入正式的微信支付，需要做以下配置，如图所示：其中mchKey 微信支付商户密钥默认就是你的商户号
- ![支付配置](imgs/img_25.png)
- 其中需要配置小程序id、商户号、以及各种证书，证书的获取方法参见微信支付官方文档
- 微信支付官方文档链接：https://pay.weixin.qq.com/doc/v3/merchant/4014931831
...
- 支持主动退款操作
- 新增门店收藏功能
- 添加【我的充值】页面 ![我的充值](imgs/img_26.png)
- 添加【我的收藏】页面 ![我的收藏](imgs/img_27.png)
- 添加【积分记录】页面 ![积分记录](imgs/img_28.png)
- 添加【意见反馈】页面 ![意见反馈](imgs/img_29.png)
- 添加【关于我们】页面 ![关于我们](imgs/img_30.png)
...
## 弄了IOT之后，想弄物联网智能开发了，感觉蛮有意思的，然后接入ai，似乎可以弄一个小型智能机器人，哈哈哈哈奥侯。
- 接下来的语音播放与语音控制应该蛮有趣吧，不过在想到底是用tts还是播放固定语音呢，哈哈哈哈哈哈
- 其实想做点有意思的东西，不过作者有时间接二开，欢迎v咱。

## 20251105更新
- 新增线上预约功能，默认展示当前最近门店的可预约桌台 ![预约首页](imgs/img_36.png)
- 支持跨时间段预约 ![预约时间段](imgs/img_37.png)
